...
public class UserSettingsActivity extends PreferenceActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        shareKeyPref.setOnPreferenceClickListener(preference -> {
            ...
            Toast.makeText(getApplicationContext(), "Yecret Key copied to clipboard", Toast.LENGTH_SHORT).show();
    ...
    private void sendMyFirstYeet() {
        ...
        message.put(ParseConstants.KEY_NOTIFICATION_TEXT, "#myFirstYeet");
