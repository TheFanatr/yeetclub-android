...
public class ChangePasswordActivity extends AppCompatActivity {
    ...
    public final static String GALLERY_DIRECTORY_MESSAGE = "com.elgami.customizer.GALLERY_DIRECTORY";
    public final static String GALLERY_FROM_CUSTOMIZER_MESSAGE = "com.elgami.customizer.GALLERY_FROM_CUSTOMIZER";
